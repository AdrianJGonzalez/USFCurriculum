...
departments = [
    {
        ...
        "module": "pages.faq.Departments.electrical_engineering_faq"
    }
    ,
    {
        "name": "Mechanical Engineering",
        "module": "pages.faq.Departments.mechanical_engineering_faq"
    }
]


# Global state for the FAQ page
...
def render(surface, area_rect, font, BLACK, BLUE, scroll_offset):
    ...
    if selected_department is None:
        ...
        # ----- DEPARTMENT MODE: Show the Department FAQ Page Without the Search Column -----
